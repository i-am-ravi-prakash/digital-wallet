...
public class WalletService {
    ...
    public void overview() {
        for (long accountNumber : wallet.getWalletAccountMap().keySet()) {
            BigDecimal walletBalance = wallet.getWalletAccountMap().get(accountNumber).getWalletBalance();
            Users currUser = wallet.getWalletAccountMap().get(accountNumber).getUsers();
            String currUserName = currUser.getUserName();
            System.out.println("Name: " + currUserName + ", Account number: " + accountNumber + ", Balance: " + walletBalance);
            // System.out.println("Balance: " +
            // wallet.getWalletAccountMap().get(accountNumber).getWalletBalance());
        }
    }
